...
extension UIColor {
    ...
    struct Color {
        ...
        static let orange: UIColor = UIColor(named: "orangeColor") ?? UIColor.init(hexString: "FFA500")
        static let grey: UIColor = UIColor(named: "greyColor") ?? UIColor.init(hexString: "7C8585 ")
